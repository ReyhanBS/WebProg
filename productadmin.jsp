  ...
  <tr bgcolor="#009966">
    ...
    <td>
        ...
        <td> <form action="#">Search : <input type="text"  name="search"/>
          ...
          <tr>
            <td align="center"><a href="insertmenu.jsp"><input type="submit" value="Input New Product"/></a><br></td>
             </tr>
            ...
            <tr>
            <td align="center"><a href="update.jsp"><input name="update" type="button" value="Update"/> 	
            <a href="deletemenu.jsp"><input name="delete" type="button" value="Delete"/>
            </td>
            </tr>
...
<%
			...
			for(int i=0;i<totalPage;i++)
			{
				...
				{
			%>
					<a href="productadmin.jsp?Page=<%=i+1%>"><%=i+1%></a>
			<%
				}
				else{
					%>
					<a href="productadmin.jsp?Page=<%=i+1%>&search=<%=request.getParameter("search")%>"><%=i+1%></a>
